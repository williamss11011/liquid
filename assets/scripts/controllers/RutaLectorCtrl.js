...
function funcionRutaLectorCtrl($scope, $rootScope, $location, ServicioLectura, ServicioSector, ServicioCuentas) {
  $scope.usuario = {
...
funcionRutaLectorCtrl.inject = ['$scope', '$rootScope', '$location', 'ServicioLectura', 'ServicioSector', 'ServicioCuentas'];
